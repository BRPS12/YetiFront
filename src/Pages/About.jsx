  ...
  return (
    <div style={{ display: "flex", flexDirection: "column" }}>
      ...
      >
        ...
        >
          -Боловсролын Тэргүүний Ажилтан Санжаагончигийн Гомбодорж,<p style={{marginTop : "1vh"}}> Боловсролын
          ...
          санаачилгаар,</p> <p style={{marginTop : "1vh"}}>-Имэкс Корпорейшн ХХК-ийн захирал Гомбодоржийн
      ...
      >
        ...
        <div style={{ marginLeft: "100px" }}>
          ...
          <p style={{ fontFamily: "Georgia, serif" , fontSize : "23px" , marginTop : "2vh" }}>2008</p>
          <p style={{ width: "500px", fontFamily: "Georgia, serif", fontSize : "23px" , marginTop : "2vh" }}>
